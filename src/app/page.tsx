      ...
      <main className="mx-auto max-w-4xl px-4 pb-20 pt-2 sm:px-6 relative">
        <CurrentPageProvider pageIndex={pageIndex}>
          <article
            ...
            className="book-content rounded-2xl border border-gray-200/60 bg-white/80 p-6 shadow-sm dark:border-[#1f1f30] dark:bg-[#12121c]/90 sm:p-8 md:p-10 lg:p-12 select-text min-h-[480px]"
          >
            {!scrollMode && (
